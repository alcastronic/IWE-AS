...
text_labels_df = pd.read_csv('./data/20ng-train-no-stop.txt', sep='\t', names=['Labels', 'Text'])
text_dataset = TextDataset(txt=text_labels_df['Text'], labels=text_labels_df['Labels'])
